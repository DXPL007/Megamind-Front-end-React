...
import PremiumImage6 from '../images/premium/vlaue.png';
						   ...
						   <Grid item className="mx-2">
							...
							<Grid item className="mx-2">
								<Paper className="grid-box">
									...
									<p className='fw-medium text-medium mt-1'> Credit Card <br/><span style={{visibility:"hidden"}}>.</span></p>
								</Paper>
							</Grid>
							<Grid item className="mx-2">
								<Paper className="grid-box">
									<img src={PremiumImage6} className="w-75" alt="logo" />
									<p className='fw-medium text-medium'> Parents Visa <br/><span style={{visibility:"hidden"}}>.</span></p>
								</Paper>
							</Grid>
